...
type Manifests interface {
	...
	// Set the values of the paths in a manifest's bytes to that given
	SetWorkloadImagePaths(def []byte, resourceID resource.ID, paths resource.ImagePath, newImageID image.Ref) ([]byte, error)
